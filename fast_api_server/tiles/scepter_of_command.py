...
class ScepterOfCommand(Tile):
            ...
            influence_tiers=[
                {
                    ...
                    "must_be_ruler": True,
                    "description": "**Action:** Move one of your disciples from a tile you rule to a tile anywhere",
                    "is_on_cooldown": False,
                    "has_a_cooldown": True,
                    "leader_must_be_present": True,
                    "data_needed_for_use": ["disciple_to_move_from_a_tile_you_rule", "slot_to_move_disciple_to"]
                },
            ],
        )
    ...
    def set_available_actions_for_use(self, game_state, tier_index, game_action_container, available_actions):
        ...
        if current_piece_of_data_to_fill == "disciple_to_move_from_a_tile_you_rule":
    ...
    async def use_a_tier(self, game_state, tier_index, game_action_container_stack, send_clients_log_message, get_and_send_available_actions, send_clients_game_state):
        ...
        tile_index_from = game_action_container.required_data_for_action['disciple_to_move_from_a_tile_you_rule']['tile_index']
        slot_index_from = game_action_container.required_data_for_action['disciple_to_move_from_a_tile_you_rule']['slot_index']
        ...
        if source_tile.determine_ruler(game_state) != user:
        ...
        await send_clients_log_message(f"{user} used **{self.name}** to move a disciple from {source_tile.name} to {game_state['tiles'][tile_index_to].name}")
